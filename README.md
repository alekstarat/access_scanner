...
В `active_hosts.txt.ssh` остаются активные хосты, так что при расширении модульной архитектуры Worker сам решит, где ещё не заworkaл
...
1. открывает `active_hosts.txt.ssh`
